...
function addActionsForHtmlUI() {
  ...
  document.getElementById("drawButton").onclick = function() { const picture = new Picture(); g_shapesList.push(picture); renderAllShapes() };


  document.getElementById("changeColorsButton").onclick = function() {
...
// var g_colors = [];  // The array to store the color of a point
 // var g_sizes = []; // The array to store the size of an object
